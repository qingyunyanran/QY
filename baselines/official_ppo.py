...
class Args:
    ...
    sim_backend: str = "cpu"
    """the simulation backend to use (physx for CPU, physx_cuda for GPU)"""
...
if __name__ == "__main__":
    ...
    # env setup
    env_kwargs = dict(obs_mode=args.obs_mode, render_mode="rgb_array", sim_backend=args.sim_backend)
